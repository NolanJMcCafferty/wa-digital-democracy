...
SUBCOMMANDS:
  ...
  merge-segments     Collapse adjacent same-speaker diarized segments into one block per turn
...
// re-parsing the stored raw Deepgram JSON. No provider call is made.
