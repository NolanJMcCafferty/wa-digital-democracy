...
//
// Mirrors the SQL function `wa_dd_normalize_entity_name` (see migration 0031)
// — both must produce the same string for the same input, otherwise candidates
// generated by the SQL JOIN will be re-classified inconsistently here. Keep
// `abbreviationExpansion` in sync with the CASE in that migration.
func NormalizedName(name string) string {
	...
	for _, w := range words {
		...
		if expanded, ok := abbreviationExpansion[w]; ok {
			w = expanded
		}
		if ignoredToken[w] {
			continue
...
var (
	...
	ignoredToken  = map[string]bool{"THE": true, "A": true, "AN": true, "OF": true, "OR": true, "AND": true, "FOR": true, "INC": true, "INCORPORATED": true, "LLC": true, "L": true, "LTD": true, "LIMITED": true, "CORP": true, "CORPORATION": true, "COMPANY": true, "PLC": true, "PC": true, "PLLC": true, "LP": true, "LLP": true, "ASSN": true, "ASSOCIATION": true}
	...
	// abbreviationExpansion mirrors the CASE in
	// db/migrations/0031_normalize_entity_abbreviations.sql. Keep in sync.
	abbreviationExpansion = map[string]string{
		"WA": "WASHINGTON", "DEPT": "DEPARTMENT", "DEPTS": "DEPARTMENTS",
		"INTL": "INTERNATIONAL", "NATL": "NATIONAL", "NAT": "NATIONAL",
		"COMM": "COMMISSION", "COMMN": "COMMISSION",
		"FED": "FEDERATION", "FEDN": "FEDERATION",
		"GOVT": "GOVERNMENT", "GOV": "GOVERNMENT",
		"UNIV": "UNIVERSITY", "COLL": "COLLEGE", "INST": "INSTITUTE",
		"SVC": "SERVICES", "SVCS": "SERVICES", "SERV": "SERVICES", "SERVS": "SERVICES",
		"TECH": "TECHNOLOGIES", "TECHS": "TECHNOLOGIES",
		"COUNCL": "COUNCIL",
		"CNTR":   "CENTER", "CTR": "CENTER", "CTRS": "CENTERS",
		"BRO": "BROTHERHOOD", "BROS": "BROTHERS",
		"INDUS": "INDUSTRIES",
		"MFG":   "MANUFACTURING", "MFR": "MANUFACTURER", "MFRS": "MANUFACTURERS",
		"CO":  "COMPANY",
		"CTY": "COUNTY", "COUN": "COUNTY",
		"AMER":  "AMERICAN",
		"ASSOC": "ASSOCIATION", "ASSOCS": "ASSOCIATES",
		"ORG": "ORGANIZATION", "ORGS": "ORGANIZATIONS",
		"GRP": "GROUP", "GRPS": "GROUPS",
		"EMPLR": "EMPLOYER", "EMPL": "EMPLOYEES", "EMPLY": "EMPLOYEES",
		"UNI":  "UNIVERSITY",
		"PROF": "PROFESSIONAL", "PROFS": "PROFESSIONALS",
		"SOC":   "SOCIETY",
		"AGNCY": "AGENCY", "AGY": "AGENCY",
		"DPT": "DEPARTMENT", "BD": "BOARD",
		"CMTY": "COMMUNITY", "COMTY": "COMMUNITY",
		"COOP":  "COOPERATIVE",
		"TRANS": "TRANSPORTATION", "TRANSP": "TRANSPORTATION",
		"PWR":  "POWER",
		"ENVT": "ENVIRONMENT", "ENV": "ENVIRONMENTAL",
		"ED": "EDUCATION", "EDU": "EDUCATION", "EDUC": "EDUCATION",
		"PUB": "PUBLIC", "GEN": "GENERAL",
